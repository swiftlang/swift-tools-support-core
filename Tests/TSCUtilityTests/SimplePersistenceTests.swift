...
class SimplePersistenceTests: XCTestCase {
    func testBasics() throws {
        ...
        let foo = Foo(int: 1, path: AbsolutePath.withPOSIX(path: "/hello"), fileSystem: fs)
        ...
        XCTAssertEqual(foo.path, AbsolutePath.withPOSIX(path: "/hello"))
    ...
    func testCanLoadFromOldSchema() throws {
        ...
        XCTAssertEqual(foo.path, AbsolutePath.withPOSIX(path: "/oldpath"))
